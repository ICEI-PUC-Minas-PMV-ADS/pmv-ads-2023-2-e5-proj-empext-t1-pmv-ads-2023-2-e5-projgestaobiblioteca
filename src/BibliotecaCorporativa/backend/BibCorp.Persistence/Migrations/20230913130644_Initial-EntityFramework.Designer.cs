...
namespace BibCorp.Persistence.Migrations
{
    ...
    [Migration("20230913130644_Initial-EntityFramework")]
    partial class InitialEntityFramework
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BibCorp.Domain.Models.Identity.Papel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BibCorp.Domain.Models.Identity.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BibCorp.Domain.Models.Identity.UsuarioPapel", b =>
                {
            ...
            modelBuilder.Entity("BibCorp.Domain.Models.Emprestimos.Emprestimo", b =>
                {
                    b.HasOne("BibCorp.Domain.Models.Identity.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("BibCorp.Domain.Models.Identity.UsuarioPapel", b =>
                {
                    b.HasOne("BibCorp.Domain.Models.Identity.Papel", "Papel")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("BibCorp.Domain.Models.Identity.Papel", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("BibCorp.Domain.Models.Identity.Usuario", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
